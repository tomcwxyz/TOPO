...
The wider remote/mobile transport experiments remain deferred behind the local product proof described in the [roadmap](../ROADMAP.md).
...
Any future remote MCP/API layer remains deferred until this local loop is proven, and must preserve local-first operation and authenticated, revocable, purpose-bound access.
