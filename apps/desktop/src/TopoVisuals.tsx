...
export function TopoTerrainBridge() {
  ...
  useEffect(() => {
    const findTargets = () => {
      setTargets({
        topbar: document.querySelector(".calm-header, .topbar"),
        heading: document.querySelector(".calm-brand, .topbar > div:first-child"),
        setup: document.querySelector(".setup-shell"),
        setupBrand: document.querySelector(".setup-brand"),
        footer: document.querySelector(".calm-footer, .app-shell > footer"),
      });
    };
